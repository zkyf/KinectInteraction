...
public:
    ...
    static T MTL_max() throw() {return T();}
...
public:
    ...
    static float MTL_max ()          MTL_LIMITS_THROW    { return FLT_MAX; }
...
public:
    ...
    static double MTL_max ()          MTL_LIMITS_THROW    { return DBL_MAX; }
...
public:
    ...
    static long double MTL_max ()          MTL_LIMITS_THROW    { return LDBL_MAX; }
...
public:
    ...
    static int MTL_max() MTL_LIMITS_THROW { return INT_MAX; }
};
...
public:
    ...
    static unsigned int MTL_max() MTL_LIMITS_THROW { return UINT_MAX; }
};
...
public:
    ...
    static long MTL_max() MTL_LIMITS_THROW { return LONG_MAX; }
};
...
public:
    ...
    static unsigned long MTL_max() MTL_LIMITS_THROW { return ULONG_MAX; }
};
...
public:
    ...
    static short MTL_max () MTL_LIMITS_THROW { return SHRT_MAX; }
};
...
public:
    ...
    static unsigned short MTL_max () MTL_LIMITS_THROW { return USHRT_MAX; }
};
...
public:
    ...
    static char MTL_max () MTL_LIMITS_THROW { return CHAR_MAX; }
};
...
public:
    ...
    static signed char MTL_max ()         MTL_LIMITS_THROW { return SCHAR_MAX; }
};
...
public:
    ...
    static unsigned char MTL_max ()         MTL_LIMITS_THROW { return UCHAR_MAX; }
};
...
public:
    ...
    static bool MTL_max ()         MTL_LIMITS_THROW { return true; }
};
#endif	/* _BOOL */
#endif
