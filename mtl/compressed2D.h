...
#if !defined(__MWERKS__) // MAT_internal compiler errors
...
//: Sparse matrix storage format with MAT_internal storage
//
...
//: Sparse matrix storage format with MAT_external storage
//
