...
namespace mtl2lapack {
  ...
  //!tparam: External - Memory managed by MTL? - MAT_internal
  //!category: mtl2lapack, generators
  //!component: type
  //!example: getrf.cc, geequ.cc, gecon.cc, geev.cc, 
  template <class T, int External=mtl::MAT_internal>
...
//
  ...
  // <UL>
  //   <LI> a       (IN/OUT - matrix(M,N)) On entry, the coefficient matrix A. On exit, its MAT_upper triangle is the min(M,N)-by-N MAT_upper triangular matrix R.  The MAT_lower triangle, together with the tau vector, is the orthogonal matrix Q as a product of min(M,N) elementary reflectors.
  //  
  ...
  // <UL>
  //   <LI> a       (IN/OUT - matrix(M,N)) On entry, the coefficient matrix A. On exit , the MAT_upper triangle and diagonal is the min(M,N) by N MAT_upper triangular matrix R.  The MAT_lower triangle, together with the tau vector, is the orthogonal matrix Q as a product of min(M,N) elementary reflectors.
  //
  ...
  // <UL>
  //   <LI> a     (IN/OUT - matrix(M,N)) On entry, the M-by-N matrix A.  On  exit, the  elements on and below the diagonal of the array contain the m-by-min(m,n) MAT_lower trapezoidal matrix L  (L  is MAT_lower  triangular if m <= n); the elements above the diagonal, with the array TAU, represent the  unitary matrix  Q as a product of elementary reflectors.
  //
