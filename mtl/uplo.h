...
//: specify an MAT_upper triangle matrix
//!noindex:
struct upper__ {
...
//: specify a unit MAT_upper triangle matrix
//!noindex:
struct unit_upper__ {
...
//: specify a MAT_lower triangle matrix
//!noindex:
struct lower__ {
...
//: specify a unit MAT_lower triangle matrix
//!noindex:
struct unit_lower__ {
...
struct dynamic_uplo__ {
  ...
  bool is_unit() const { return uplo == MAT_unit_upper || uplo == MAT_unit_lower; }
  bool is_upper() const { return uplo == MAT_upper || uplo == MAT_unit_upper; }
  int uplo;
};
