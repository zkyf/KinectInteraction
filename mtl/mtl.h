...
//: Max Index:  <tt>i <- index of MTL_max(|x(i)|)</tt>
//!category: algorithms
//!component: function
//!definition: mtl.h
//!complexity: O(n)
...
//: Maximum Absolute Index:  <tt>i <- index of MTL_max(|x(i)|)</tt>
//!category: algorithms
//!component: function
//!definition: mtl.h
//!complexity: O(n)
...
#undef MTL_BLAS_GROT
//do allow MAT_internal macro escape out of the scope
...
//  is an MAT_upper or MAT_lower triangular matrix, and B is a general
